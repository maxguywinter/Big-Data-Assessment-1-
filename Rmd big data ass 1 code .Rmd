---
title: "Big data assessment 1 code"
author: "Max Winter"
date: "19/02/2022"
...
p1 <- fviz_cluster(k2, geom = "point", data = df) + ggtitle("k = 2") # plots to compare
...
set.seed(123)
gap_stat <- clusGap(df, FUN = kmeans, nstart = 25, # compute gap statistic
                    K.max = 10, B = 50)
